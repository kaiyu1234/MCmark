...
score_path='./results/mmw_book_report/Mistral_7B_Instruct_v0.3/mcmark/score_random_token_replacement_eps_0_1.txt'

fpr=0.01
# autodl-tmp/results/mmw_book_report/Mistral_7B_Instruct_v0.3/mcmark/score.txt
# for baselines
